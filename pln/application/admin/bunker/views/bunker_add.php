		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Bunker <small>Bunker Add Data</small></h1>
			<!-- end page-header -->
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Add Bunker - Table</h4>
                        </div>
                        <div class="panel-body">
                        	<form action="<?php echo base_url(); ?>index.php/bunker/add_data/" method="post">
	                            <div class="row">
	                                <div class="col-md-4">
	                                    <div class="form-group">
	                                        <label>Bunker Name</label>
	                                        <div class="controls">
	                                            <input type="text" name="bunker_name" value="" class="form-control" />
	                                        </div>
	                                ...
	                                <div class="col-md-4">
	                                    <div class="form-group">
	                                        ...
	                                        <div class="controls">
	                                            <input type="text" name="bunker_type" value="" class="form-control" />
	                                        </div>

		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Port <small>Port Confirm Delete Data</small></h1>
			<!-- end page-header -->
			...
			<div class="row">
			    <!-- begin col-12 -->
			    <div class="col-md-12">
                    <form method="post" action="<?php echo base_url(); ?>index.php/port/delete_data/">
                        <?php foreach($port->result() as $row) { ?>
						<div class="row">
			                <div class="col-md-12">
			                    <div class="alert alert-danger alert-dismissible" role="alert">
			                      <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			                      <strong><i class="fa fa-info-circle"></i> Are you sure to remove <?php echo $row->port_name; ?> ? </strong>

...
<head>
	<meta charset="utf-8" />
	<title><?php echo get_setting('login_title'); ?></title>
...
<body>
	...
	<div class="login-cover">
	    <div class="login-cover-image"><img src="<?php echo get_setting('cover_image'); ?>" data-id="login-cover-image" alt="" /></div>
        ...
        <div class="login login-v2" data-pageload-addclass="animated fadeIn">
            ...
            <div class="login-header">
                <div class="brand">
                	<small>&nbsp;</small>
                	<center>
                    <img width="<?php echo get_setting('brand_width'); ?>" height="<?php echo get_setting('brand_height'); ?>" src="<?php echo get_setting('brand_logo'); ?>" /></center>

		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Vessel <small>Vessel Add Data</small></h1>
			<!-- end page-header -->
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Add Vessel - Table</h4>
                        </div>
                        <div class="panel-body">
                        	<form action="<?php echo base_url(); ?>index.php/vessel/add_data/" method="post">
	                            <div class="row">
	                                <div class="col-md-4">
	                                    <div class="form-group">
	                                        <label>Vessel Name</label>
	                                        <div class="controls">
	                                            <input type="text" name="vessel_name" value="" class="form-control" />
	                                        </div>
	                                ...
	                                <div class="col-md-4">
	                                    <div class="form-group">
	                                        ...
	                                        <div class="controls">
	                                            <input type="text" name="vessel_type" value="" class="form-control" />
	                                        </div>

		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Vessel <small>Vessel Confirm Update Data</small></h1>
			<!-- end page-header -->
			...
			<div class="row">
			    <!-- begin col-12 -->
			    <div class="col-md-12">
                    <form method="post" action="<?php echo base_url(); ?>index.php/vessel/update_data/">
						<div class="row">
			                <div class="col-md-12">
			                    <div class="alert alert-danger alert-dismissible" role="alert">
			                      ...
			                      <input type="hidden" name="vessel_name" value="<?php echo $vessel_name; ?>" />
			                      <input type="hidden" name="vessel_type" value="<?php echo $vessel_type; ?>" />
			                    </div>
			                </div>
		            	</div>

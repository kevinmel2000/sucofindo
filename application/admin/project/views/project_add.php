             ...
             <div class="col-md-12">
                 ...
                 <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Add Project - Table</h4>
                    </div>
                    <div class="panel-body">
                    <form action="<?php echo base_url(); ?>index.php/project/add_data/" method="post">
                        <div row>
                                        ...
                                        <td>
                                            <select name="projcat_id" class="form-control select2">
                                                <?php foreach($projcat->result() as $row) {
                                                    echo "<option value='".$row->projcat_id."'>".$row->projcat_name."</option>";
                                                } ?>
                                            </select>
                                        </td>
                                        <td>
                                            <?php  echo form_error('projcat_id', '<label class="error-red">', '</label>'); ?>
                                        </td>
                                    </tr>
                                </table>
                            </div>

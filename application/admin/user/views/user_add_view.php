                ...
                <div class="panel-body" style="overflow-x: hidden;">
					...
					<table class="table table-striped  table-bordered">
						...
						<tr>
							...
							<td>
								<?php echo form_upload(array('type' => 'file', 'name' => 'photo_upload','class' => 'form-control')); ?>
								<?php echo br(); ?>
								<?php echo img(array('src' => 'http://vvcexpl.com/wordpress/wp-content/uploads/2013/09/profile-default-male.png','class' => 'thumbnail', 'width' => '100px', 'height' => '130px')); ?>
							</td>
						</tr>
						<tr>
							...
							if($user_group->num_rows() > 0) {
								foreach($user_group->result() as $row_user_group) {
									$dropdown_user_group[$row_user_group->GROUP_ID] = $row_user_group->GROUP_NAME;
								}
							}

			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Preview Project Category - Table</h4>
                        </div>
                        <div class="panel-body">
                            <form action="<?php echo base_url(); ?>index.php/projcat/update_data/" method="post">
                                <div class="row">
                                <?php foreach($projcat->result() as $row) { ?>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="hidden" name="projcat_id" value="<?php echo $row->projcat_id; ?>" />
                                                <input type="text" name="projcat_name" value="<?php echo $row->projcat_name; ?>" class="form-control" />

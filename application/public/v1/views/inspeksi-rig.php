				...
				<div class="container clearfix">
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 m_xs_bottom_30">
							<h3 class="color_dark fw_light m_bottom_15 heading_1 t_align_c">Layanan Kami - Inspeksi Rig</h3>		
							<div class="row">
								<ul class="col-lg-12 col-md-12 col-sm-12 fw_light w_break m_bottom_45 m_xs_bottom_30">
									<li class="m_bottom_8">
										<div class="d_inline_m icon_wrap_size_1 color_green circle m_right_10">
											<i class="icon-check"></i>
										</div>
										<b>Layanan Jasa Inspeksi Rig</b>
										<div style="padding-left:37px">
											“Keselamatan Kerja dan Operasi” merupakan kebutuhan pokok pada setiap elemen yang terkait dengan pengoperasian peralatan dan instalasi rig. Instalasi rig dinyatakan layak pakai dan memenuhi persyaratan keselamatan kerja hanya dapat dibuktikan setelah mengalami proses pemeriksaan teknis.
										</div>
									</li>
									<li class="m_bottom_8">
										<div class="d_inline_m icon_wrap_size_1 color_green circle m_right_10">
										...
										<b>Metodologi</b>
										<div style="padding-left:37px">
											<img src="<?php echo base_url(); ?>assets/public/sucofindo/old-images/rig-inspection-03.png" />
										</div>
									</li>									
								</ul>
							</div>

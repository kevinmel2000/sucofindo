				...
				<div class="container clearfix">
					<div class="row">
							...
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-6 m_xs_bottom_30">
									<ul class="vr_list_type_4 color_dark fw_light">
										<li class="m_bottom_12">
											<a href="index.html" class="color_dark d_inline_b">
										...
										<li class="m_bottom_12">
											<a href="pages_about.html" class="color_dark d_inline_b">
												<span class="icon_wrap_size_0 circle color_grey_light_5 d_block tr_inherit f_left">
													<i class="icon-angle-right"></i>
												</span>
												About Us
										...
										<li class="m_bottom_12">
											<a href="pages_services.html" class="color_dark d_inline_b">
												<span class="icon_wrap_size_0 circle color_grey_light_5 d_block tr_inherit f_left">
													<i class="icon-angle-right"></i>
												</span>
												Services
								...
								<div class="col-lg-6 col-md-6 col-sm-6 m_xs_bottom_30">
									<ul class="vr_list_type_2 color_dark fw_light">
										<li class="m_bottom_12">
											<a href="portfolio_classic_1_column.html" class="color_dark d_inline_b">
												<span class="icon_wrap_size_0 circle color_grey_light_5 d_block tr_inherit f_left">
													<i class="icon-angle-right"></i>
												</span>
												Portfolio
										...
										<li class="m_bottom_12">
											<a href="blog_classic_1_column.html" class="color_dark d_inline_b">
												<span class="icon_wrap_size_0 circle color_grey_light_5 d_block tr_inherit f_left">
													<i class="icon-angle-right"></i>
												</span>
												Blog
										...
										<li class="m_bottom_12">
											<a href="pages_contact.html" class="color_dark d_inline_b">
												<span class="icon_wrap_size_0 circle color_grey_light_5 d_block tr_inherit f_left">
													<i class="icon-angle-right"></i>
												</span>
												Contact
						...
						<div class="col-lg-4 col-md-4 col-sm-5 m_xs_bottom_30">
							...
							<!--searchform-->
							<form role="search" class="relative type_2">
								<input type="text" placeholder="Enter text" class="r_corners fw_light bg_light w_full">

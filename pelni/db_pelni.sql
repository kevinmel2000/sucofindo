...
(1, 'app_name', 'Pelni'),
(2, 'cover_image', 'http://1.bp.blogspot.com/-k3DU7DtJNus/UxpjhBX7D2I/AAAAAAAAAW8/joo_nXra-yE/s1600/Cermai.jpg'),
(3, 'logo', 'http://rmol.co/images/berita/thumb/thumb_180505_11331225112014_PT-Pelayaran-Nasional-Indo%C2%ADnesia-(Persero).jpg'),
(4, 'login_title', 'Pelni Monitoring System'),
(5, 'brand_height', '75px'),
(6, 'brand_width', '169px'),
(7, 'brand_logo', 'https://static1.squarespace.com/static/54fc01dde4b0d3db827e2a42/56f35e3d2eeb81c4963b1f88/56f3619acf80a1a5ee965859/1458790813044/BUMN+PELNI+logo.png'),
(8, 'logo_width', '180px'),
(9, 'logo_height', '40px'),
(10, 'logo_image', 'https://i0.wp.com/lingkarglobal.com/wp-content/uploads/2017/07/PT-PELNI.jpg?fit=450%2C200');
